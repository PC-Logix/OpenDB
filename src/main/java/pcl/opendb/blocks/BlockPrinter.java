...
public class BlockPrinter extends BlockContainer {
	...
	public BlockPrinter() {
		super(Material.iron );
		setCreativeTab(OpenDB.CreativeTab);
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int metadata, float clickX, float clickY, float clickZ) {
		...
		player.openGui(OpenDB.instance, 0, world, x, y, z);
		return true;
	}
	...
	{
		sideIcon = ir.registerIcon(OpenDB.MODID + ":block_side");
		frontIcon = ir.registerIcon(OpenDB.MODID + ":printer_front");
	}
